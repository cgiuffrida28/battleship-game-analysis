...
public class Phase4Runner {
    public static void main(String[] args) throws IOException {
        ...
        final String csvFilePath = "phase4_ai_comparison_results.csv";
        ...
        BattleshipAI probabilityMapAI = new ProbabilityMapAI(baseSeed);
        ...
        List<SimulationResult> probabilityMapResults = runner.runFixedBoardGames(probabilityMapAI, numberOfGames);
        ...
        System.out.println("Phase 4: ProbabilityMapAI fixed-board benchmark");
        System.out.println("------------------------------------------------");
